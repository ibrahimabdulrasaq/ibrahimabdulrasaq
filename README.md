...
Here are some of the projects you will find on my GitHub repositories

#### 📌 Bank Customer Churn Analysis
- Problem: High customer churn affecting retention rates  
- Solution: Built Power BI dashboards and analyzed behavioral patterns  
- Impact: Identified top churn risk segments, enabling targeted retention campaigns with a **projected 12% reduction in churn**  
- Tools & Technologies: Power BI • Power Query (ETL) • DAX • PowerPoint (Executive Reporting)

#### 📌 Sales Performance Dashboard
- Problem: Lack of visibility on regional sales trends  
- Solution: Cleaned and transformed sales data, built KPI dashboards  
- Impact: Highlighted underperforming regions and top-selling products, **driving strategic focus for 15% revenue growth**
...
> Dashboards and screenshots are included in individual repositories.

**⭐ If a project adds value or inspires you, feel free to star the repo or reach out!**
...
<p align="center">
  ...
  <a href="https://www.linkedin.com/in/ibrahim-abdulrasaq">
